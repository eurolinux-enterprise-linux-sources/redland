...
void n3_lexer_set_lineno (int  line_number , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           yy_fatal_error( "n3_lexer_set_lineno called with no buffer" , yyscanner); 
...
void n3_lexer_set_column (int  column_no , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           yy_fatal_error( "n3_lexer_set_column called with no buffer" , yyscanner); 
...
{
	if(ptr) free( (char *) ptr );	/* see n3_lexer_realloc() for (char *) cast */
}
